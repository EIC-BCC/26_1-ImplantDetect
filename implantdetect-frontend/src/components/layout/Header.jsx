...
const Header = () => {
  ...
  return (
    <header
      className={`sticky top-0 z-50 ${isLanding ? "bg-white/80 backdrop-blur-md" : "bg-white"} border-b border-gray-200`}
    >
          ...
          <nav className="hidden md:flex items-center gap-1">
            {token ? (
              <>
                ...
                <Link
                  to="/images/upload"
                  className={navLinkClass("/images/upload")}
                >
                ...
                <Link
                  to="/images/history"
                  className={navLinkClass("/images/history")}
                >
