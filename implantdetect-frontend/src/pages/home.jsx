const Home = () => {
    return (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '60vh' }}>
            <h1 style={{ marginBottom: '10px', fontSize: '3em', display: 'flex', alignItems: 'center' }}>
            ...
            <p style={{ fontSize: '0.9em', color: '#888', marginTop: '30px' }}>
                ...
                <a href="https://github.com/marceloareas/implantdetect" target="_blank" rel="noopener noreferrer">GitHub</a>
            </p>
        </div>
    );
}
