...
import { Clock, CheckCircle, XCircle, AlertTriangle, Eye, Loader2 } from 'lucide-react';
  ...
  useEffect(() => {
    const fetchProcesses = async () => {
      ...
      try {
        ...
        setProcesses(data.sort((a, b) => new Date(b.created_at) - new Date(a.created_at)));
      } catch (err) {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-1">Acompanhe todas as suas análises de radiografias</p>
      </div>
              ...
              <Card key={process.process_id} hover className="group">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div className="flex items-center gap-4">
                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center bg-${config.color}-50`}>
